...
int main() {
	...
	if(string("00000000") == STUDENT_ID) 
		throw std::runtime_error("please fill in your student ID");
	...
	predicted_postags.push_back(sentence_postags);
        ...
        auto accuracy = compute_accuracy(predicted_postags, test_postags, test_sents);
