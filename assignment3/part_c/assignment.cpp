...
/*
  ...
  vector<feature_t> get_features(const vector<token_t> &sentence, const vector<symbol_t> &postags, const vector<symbol_t> &shallow_syntactic_tags, unsigned target_index, unsigned predicate_index) {
    return vector<feature_t>{sentence[target_index], sentence[predicate_index], postags[target_index], postags[predicate_index], shallow_syntactic_tags[target_index], (double) target_index - predicate_index};
  }
  ...
  vector<feature_t> get_features(const vector<token_t> &sentence, const vector<symbol_t> &postags, const vector<symbol_t> &shallow_syntactic_tags, unsigned target_index, unsigned predicate_index) {
    ...
    return vector<feature_t>{sentence[target_index], postags[predicate_index], postags[target_index], shallow_syntactic_tags[target_index]
    };
  }
  ...
  vector<feature_t> get_features(const vector<token_t> &sentence, const vector<symbol_t> &postags, const vector<symbol_t> &shallow_syntactic_tags, unsigned target_index, unsigned predicate_index) {
    ...
    return vector<feature_t>{sentence[target_index], sentence[predicate_index], postags[target_index], shallow_syntactic_tags[target_index], (double) target_index - predicate_index, (double) sentence.size()};
  }
  ...
  transducer_t your_classifier(const vector <sentence_t> &training_set, const vector <symbol_t> &postag_vocab, const vector <symbol_t> &iobes_syntactic_tag_vocab, const vector <symbol_t> &iobes_semantic_role_vocab) {
    ...
    auto postag_onehot = make_onehot(postag_vocab);
    auto iobes_syntactic_onehot = make_onehot(iobes_syntactic_tag_vocab);
    auto concatenate = make_concatenate(7);
    auto dense0 = make_dense_feedfwd(64, make_tanh());
    auto dense1 = make_dense_feedfwd(iobes_semantic_role_vocab.size(), make_softmax());
    auto onehot_inverse = make_onehot_inverse(iobes_semantic_role_vocab);
    return compose(
  ...
  vector<feature_t> get_features(const vector<token_t> &sentence, const vector<symbol_t> &postags, const vector<symbol_t> &shallow_syntactic_tags, unsigned target_index, unsigned predicate_index) {
    ...
    return vector<feature_t>{sentence[target_index], sentence[predicate_index], postags[target_index], postags[predicate_index], shallow_syntactic_tags[target_index], (double) target_index - predicate_index, (double) sentence.size()};
  }
...
*/
  ...
  transducer_t your_classifier(const vector <sentence_t> &training_set, const vector <symbol_t> &postag_vocab, const vector <symbol_t> &iobes_syntactic_tag_vocab, const vector <symbol_t> &iobes_semantic_role_vocab) {
    ...
    auto postag_onehot = make_onehot(postag_vocab);
    auto iobes_syntactic_onehot = make_onehot(iobes_syntactic_tag_vocab);
    auto concatenate = make_concatenate(9);
    auto dense0 = make_dense_feedfwd(64, make_tanh());
    auto dense1 = make_dense_feedfwd(iobes_semantic_role_vocab.size(), make_softmax());
    auto onehot_inverse = make_onehot_inverse(iobes_semantic_role_vocab);
    return compose(
  ...
  vector<feature_t> get_features(const vector<token_t> &sentence, const vector<symbol_t> &postags, const vector<symbol_t> &shallow_syntactic_tags, unsigned target_index, unsigned predicate_index) {
	feature_t next = (target_index > 0) ? postags[target_index-1] : "<s>"; 
	feature_t prev = (int(target_index) < int(postags.size())-1) ? postags[target_index+1]:"<s>";

    return vector<feature_t>{sentence[target_index], sentence[predicate_index],prev, postags[target_index], next, postags[predicate_index], shallow_syntactic_tags[target_index], (double) target_index - predicate_index, (double) sentence.size()};
 }
}
