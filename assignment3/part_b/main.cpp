...
int main() {
  ...
  auto [train_sents, train_iobes_tags] = read_dataset("/project/cl/httpd/htdocs/COMP4221_2019Q1_a3/res/traindata_part_b_iobes.xml");
  ...
  auto [test_sents, test_postags] = read_dataset("/project/cl/httpd/htdocs/COMP4221_2019Q1_a3/res/devdata_part_b_iobes.xml");
